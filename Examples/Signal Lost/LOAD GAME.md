...
List all directories under `saves/`. For each save, read `player.md` and `world_state.md` to show a preview:
...
3. Present the current scene from `session/location.md`.
